...
public class ClientboundRespawnPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundRespawnPacket(ResourceKey<DimensionType> pDimensionType, ResourceKey<Level> pDimension, long pSeed, GameType pPlayerGameType, @Nullable GameType pPreviousPlayerGameType, boolean pIsDebug, boolean pIsFlat, byte pDataToKeep, Optional<GlobalPos> pLastDeathLocation) {
