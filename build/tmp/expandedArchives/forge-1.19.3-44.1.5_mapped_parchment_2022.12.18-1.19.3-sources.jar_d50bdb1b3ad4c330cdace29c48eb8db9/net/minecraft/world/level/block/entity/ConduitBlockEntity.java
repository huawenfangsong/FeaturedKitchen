...
public class ConduitBlockEntity extends BlockEntity {
   ...
   private static void updateDestroyTarget(Level pLevel, BlockPos pPos, BlockState pState, List<BlockPos> pPositions, ConduitBlockEntity pBlockEntity) {
      ...
      if (i < 42) {
         ...
         List<LivingEntity> list = pLevel.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(pPos), (p_253604_) -> {
   ...
   private static LivingEntity findDestroyTarget(Level pLevel, BlockPos pPos, UUID pTargetId) {
      List<LivingEntity> list = pLevel.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(pPos), (p_253606_) -> {
         return p_253606_.getUUID().equals(pTargetId);
      });
