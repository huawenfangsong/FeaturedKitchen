...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   public void neighborChanged(BlockPos pPos, Block pBlock, BlockPos pFromPos) {
      this.addAndRun(pPos, new CollectingNeighborUpdater.SimpleNeighborUpdate(pPos, pBlock, pFromPos.immutable()));
   }

   public void neighborChanged(BlockState pState, BlockPos pPos, Block pBlock, BlockPos pFromPos, boolean pIsMoving) {
      this.addAndRun(pPos, new CollectingNeighborUpdater.FullNeighborUpdate(pState, pPos.immutable(), pBlock, pFromPos.immutable(), pIsMoving));
   }
