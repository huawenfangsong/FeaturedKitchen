...
public class CreativeModeTab {
   ...
   public void buildContents(FeatureFlagSet pEnabledFeatures, boolean pDisplayOperatorCreativeTab) {
      CreativeModeTab.ItemDisplayBuilder creativemodetab$itemdisplaybuilder = new CreativeModeTab.ItemDisplayBuilder(this, pEnabledFeatures);
      net.minecraftforge.client.ForgeHooksClient.onCreativeModeTabBuildContents(this, this.displayItemsGenerator, pEnabledFeatures, creativemodetab$itemdisplaybuilder, pDisplayOperatorCreativeTab);
   ...
   public interface DisplayItemsGenerator {
      void accept(FeatureFlagSet pEnabledFeatures, CreativeModeTab.Output pOutput, boolean pDisplayOperatorCreativeTab);
   }
