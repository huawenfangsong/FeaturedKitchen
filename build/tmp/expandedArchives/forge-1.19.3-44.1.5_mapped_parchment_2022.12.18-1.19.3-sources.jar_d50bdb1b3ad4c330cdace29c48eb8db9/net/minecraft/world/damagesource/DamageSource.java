...
public class DamageSource {
   ...
   public static DamageSource explosion(@Nullable Explosion pExplosion) {
      return pExplosion != null ? explosion(pExplosion.getDirectSourceEntity(), pExplosion.getIndirectSourceEntity()) : explosion((Entity)null, (Entity)null);
   }

   public static DamageSource explosion(@Nullable Entity pDirectSource, @Nullable Entity pIndirectSource) {
      if (pIndirectSource != null && pDirectSource != null) {
         return (new IndirectEntityDamageSource("explosion.player", pDirectSource, pIndirectSource)).setScalesWithDifficulty().setExplosion();
      } else {
         return pDirectSource != null ? (new EntityDamageSource("explosion", pDirectSource)).setScalesWithDifficulty().setExplosion() : (new DamageSource("explosion")).setScalesWithDifficulty().setExplosion();
      }
   }
   ...
   public DamageSource(String pMsgId) {
      this.msgId = pMsgId;
   }
