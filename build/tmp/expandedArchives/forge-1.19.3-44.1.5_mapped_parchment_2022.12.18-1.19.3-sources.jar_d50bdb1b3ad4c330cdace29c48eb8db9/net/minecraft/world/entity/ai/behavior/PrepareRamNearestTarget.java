...
public class PrepareRamNearestTarget<E extends PathfinderMob> extends Behavior<E> {
   ...
   private void chooseRamPosition(PathfinderMob pPathfinder, LivingEntity pEntity) {
      ...
      this.ramCandidate = this.calculateRammingStartPosition(pPathfinder, pEntity).map((p_253530_) -> {
         return new PrepareRamNearestTarget.RamCandidate(p_253530_, pEntity.blockPosition(), pEntity);
      });
   }
