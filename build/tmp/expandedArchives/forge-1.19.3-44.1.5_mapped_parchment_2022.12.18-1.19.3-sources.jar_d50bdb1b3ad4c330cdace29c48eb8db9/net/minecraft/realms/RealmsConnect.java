      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               RealmsConnect.this.connection.setListener(new ClientHandshakePacketListenerImpl(RealmsConnect.this.connection, minecraft, pServer.toServerData(s), RealmsConnect.this.onlineScreen, false, (Duration)null, (p_120726_) -> {
               }));
               if (RealmsConnect.this.aborted) {
                  return;
               }
