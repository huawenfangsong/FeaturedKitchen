...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider pRegistries, Consumer<Advancement> pWriter) {
      Advancement advancement = this.createRoot(pWriter);
      Advancement advancement1 = Advancement.Builder.advancement().parent(advancement).display(Items.WHEAT, Component.translatable("advancements.husbandry.plant_seed.title"), Component.translatable("advancements.husbandry.plant_seed.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).addCriterion("wheat", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.WHEAT)).addCriterion("pumpkin_stem", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.PUMPKIN_STEM)).addCriterion("melon_stem", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.MELON_STEM)).addCriterion("beetroots", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.BEETROOTS)).addCriterion("nether_wart", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.NETHER_WART)).save(pWriter, "husbandry/plant_seed");
      Advancement advancement2 = this.createBreedAnAnimalAdvancement(advancement, pWriter);
      this.createBreedAllAnimalsAdvancement(advancement2, pWriter);
      ...
      Advancement advancement5 = this.addFishBuckets(Advancement.Builder.advancement()).parent(advancement4).requirements(RequirementsStrategy.OR).display(Items.PUFFERFISH_BUCKET, Component.translatable("advancements.husbandry.tactical_fishing.title"), Component.translatable("advancements.husbandry.tactical_fishing.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(pWriter, "husbandry/tactical_fishing");
   ...
   Advancement createBreedAnAnimalAdvancement(Advancement pParent, Consumer<Advancement> pWriter) {
      return Advancement.Builder.advancement().parent(pParent).display(Items.WHEAT, Component.translatable("advancements.husbandry.breed_an_animal.title"), Component.translatable("advancements.husbandry.breed_an_animal.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).addCriterion("bred", BredAnimalsTrigger.TriggerInstance.bredAnimals()).save(pWriter, "husbandry/breed_an_animal");
   }

   Advancement createBreedAllAnimalsAdvancement(Advancement pParent, Consumer<Advancement> pWriter) {
      return this.addBreedable(Advancement.Builder.advancement()).parent(pParent).display(Items.GOLDEN_CARROT, Component.translatable("advancements.husbandry.breed_all_animals.title"), Component.translatable("advancements.husbandry.breed_all_animals.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(pWriter, "husbandry/bred_all_animals");
   }

   private Advancement.Builder addLeashedFrogVariants(Advancement.Builder pBuilder) {
      BuiltInRegistries.FROG_VARIANT.holders().forEach((p_249424_) -> {
         pBuilder.addCriterion(p_249424_.key().location().toString(), PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(Items.LEAD), EntityPredicate.Composite.wrap(EntityPredicate.Builder.entity().of(EntityType.FROG).subPredicate(EntitySubPredicate.variant(p_249424_.value())).build())));
      });
      return pBuilder;
   }
   ...
   Advancement.Builder addBreedable(Advancement.Builder pBuilder) {
