...
public class PackMetadataGenerator implements DataProvider {
   ...
   public static PackMetadataGenerator forFeaturePack(PackOutput pOutput, Component pDescription) {
      return (new PackMetadataGenerator(pOutput)).add(PackMetadataSection.TYPE, new PackMetadataSection(pDescription, DetectedVersion.BUILT_IN.getPackVersion(PackType.DATA)));
   }
