...
public class Main {
   ...
   public static DataGenerator createStandardGenerator(Path pOutputFolder, Collection<Path> pInputFolders, boolean pClient, boolean pServer, boolean pDev, boolean pReports, boolean pValidate, WorldVersion pVersion, boolean pAlwaysGenerate) {
      ...
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(pServer);
      ...
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(pDev);
      datagenerator$packgenerator1.addProvider((p_253386_) -> {
         return new NbtToSnbt(p_253386_, pInputFolders);
      });
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(pReports);
      ...
      datagenerator$packgenerator1 = datagenerator.getBuiltinDatapack(pServer, "bundle");
      ...
      datagenerator$packgenerator1 = datagenerator.getBuiltinDatapack(pServer, "update_1_20");
