...
public class UpgradeRecipeBuilder {
   ...
   public UpgradeRecipeBuilder(RecipeSerializer<?> pType, Ingredient pBase, Ingredient pAddition, RecipeCategory pCategory, Item pResult) {
   ...
   public static UpgradeRecipeBuilder smithing(Ingredient pBase, Ingredient pAddition, RecipeCategory pCategory, Item pResult) {
      return new UpgradeRecipeBuilder(RecipeSerializer.SMITHING, pBase, pAddition, pCategory, pResult);
   }
   ...
   public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pId) {
      ...
      pFinishedRecipeConsumer.accept(new UpgradeRecipeBuilder.Result(pId, this.type, this.base, this.addition, this.result, this.advancement, pId.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
