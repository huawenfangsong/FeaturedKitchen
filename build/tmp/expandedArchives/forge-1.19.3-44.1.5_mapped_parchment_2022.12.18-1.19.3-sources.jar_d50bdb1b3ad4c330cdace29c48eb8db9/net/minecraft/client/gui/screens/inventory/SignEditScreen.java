...
public class SignEditScreen extends AbstractSignEditScreen {
   ...
   protected void offsetSign(PoseStack pPoseStack, BlockState pState) {
      super.offsetSign(pPoseStack, pState);
      boolean flag = pState.getBlock() instanceof StandingSignBlock;
      if (!flag) {
         pPoseStack.translate(0.0F, 35.0F, 0.0F);
      }

   }

   protected void renderSignBackground(PoseStack pPoseStack, MultiBufferSource.BufferSource pBufferSource, BlockState pState) {
      if (this.signModel != null) {
         boolean flag = pState.getBlock() instanceof StandingSignBlock;
         pPoseStack.translate(0.0F, 31.0F, 0.0F);
         pPoseStack.scale(62.500004F, 62.500004F, -62.500004F);
         Material material = Sheets.getSignMaterial(this.woodType);
         VertexConsumer vertexconsumer = material.buffer(pBufferSource, this.signModel::renderType);
