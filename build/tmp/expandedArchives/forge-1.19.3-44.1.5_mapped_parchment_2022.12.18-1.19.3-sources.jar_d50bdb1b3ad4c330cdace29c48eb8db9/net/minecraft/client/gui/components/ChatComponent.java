...
public class ChatComponent extends GuiComponent {
   ...
   public void render(PoseStack pPoseStack, int pTickCount, int pMouseX, int pMouseY) {
      if (!this.isChatHidden()) {
         ...
         if (j > 0) {
               ...
               if (guimessage$line != null) {
                  ...
                  if (l2 < 200 || flag) {
                     ...
                     if (j3 > 3) {
                        ...
                        int j4 = i4 + l1;
                        pPoseStack.pushPose();
                        pPoseStack.translate(0.0F, 0.0F, 50.0F);
                        fill(pPoseStack, -4, i4 - k1, 0 + k + 4 + 4, i4, k3 << 24);
                        GuiMessageTag guimessagetag = guimessage$line.tag();
                        if (guimessagetag != null) {
                           int k4 = guimessagetag.indicatorColor() | j3 << 24;
                           fill(pPoseStack, -4, i4 - k1, -2, i4, k4);
                           if (k2 == j1 && guimessagetag.icon() != null) {
                              int l4 = this.getTagIconLeft(guimessage$line);
                              int i5 = j4 + 9;
                              this.drawTagIcon(pPoseStack, l4, i5, guimessagetag.icon());
                           }
                        }

                        RenderSystem.enableBlend();
                        pPoseStack.translate(0.0F, 0.0F, 50.0F);
                        this.minecraft.font.drawShadow(pPoseStack, guimessage$line.content(), 0.0F, (float)j4, 16777215 + (j3 << 24));
            ...
            if (j5 > 0L) {
               ...
               pPoseStack.pushPose();
               pPoseStack.translate(0.0F, (float)i1, 50.0F);
               fill(pPoseStack, -2, 0, k + 4, 9, i6 << 24);
               RenderSystem.enableBlend();
               pPoseStack.translate(0.0F, 0.0F, 50.0F);
               this.minecraft.font.drawShadow(pPoseStack, Component.translatable("chat.queue", j5), 0.0F, 1.0F, 16777215 + (k5 << 24));
               pPoseStack.popPose();
               RenderSystem.disableBlend();
            }
            ...
            if (flag) {
               ...
               if (j6 != k6) {
                  ...
                  int k7 = k + 4;
                  fill(pPoseStack, k7, -i3, k7 + 2, -i3 - l6, j7 + (i7 << 24));
                  fill(pPoseStack, k7 + 2, -i3, k7 + 1, -i3 - l6, 13421772 + (i7 << 24));
               }
            }
