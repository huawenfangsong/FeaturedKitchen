...
public abstract class AbstractSliderButton extends AbstractWidget {
   ...
   protected void renderBg(PoseStack pPoseStack, Minecraft pMinecraft, int pMouseX, int pMouseY) {
      ...
      this.blit(pPoseStack, this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 0, 46 + i, 4, 20);
      this.blit(pPoseStack, this.getX() + (int)(this.value * (double)(this.width - 8)) + 4, this.getY(), 196, 46 + i, 4, 20);
   }
