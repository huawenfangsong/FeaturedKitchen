...
public class RecipeBookTabButton extends StateSwitchingButton {
   ...
   public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
      if (this.animationTime > 0.0F) {
         ...
         pPoseStack.pushPose();
         pPoseStack.translate((float)(this.getX() + 8), (float)(this.getY() + 12), 0.0F);
      ...
      this.blit(pPoseStack, k, this.getY(), i, j, this.width, this.height);
   ...
   private void renderIcon(ItemRenderer pItemRenderer) {
      ...
      if (list.size() == 1) {
         pItemRenderer.renderAndDecorateFakeItem(list.get(0), this.getX() + 9 + i, this.getY() + 5);
      } else if (list.size() == 2) {
         pItemRenderer.renderAndDecorateFakeItem(list.get(0), this.getX() + 3 + i, this.getY() + 5);
         pItemRenderer.renderAndDecorateFakeItem(list.get(1), this.getX() + 14 + i, this.getY() + 5);
      }
