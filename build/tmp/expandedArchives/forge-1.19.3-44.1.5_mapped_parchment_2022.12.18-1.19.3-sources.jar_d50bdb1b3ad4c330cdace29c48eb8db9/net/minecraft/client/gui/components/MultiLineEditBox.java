...
public class MultiLineEditBox extends AbstractScrollWidget {
      ...
      if (s.isEmpty() && !this.isFocused()) {
         ...
         for(MultilineTextField.StringView multilinetextfield$stringview : this.textField.iterateLines()) {
            ...
            if (flag && flag1 && i >= multilinetextfield$stringview.beginIndex() && i <= multilinetextfield$stringview.endIndex()) {
               if (flag2) {
                  j = this.font.drawShadow(pPoseStack, s.substring(multilinetextfield$stringview.beginIndex(), i), (float)(this.getX() + this.innerPadding()), (float)l, -2039584) - 1;
               ...
               if (flag2) {
                  j = this.font.drawShadow(pPoseStack, s.substring(multilinetextfield$stringview.beginIndex(), multilinetextfield$stringview.endIndex()), (float)(this.getX() + this.innerPadding()), (float)l, -2039584) - 1;
               }
   ...
   protected void renderDecorations(PoseStack pPoseStack) {
      ...
      if (this.textField.hasCharacterLimit()) {
         ...
         drawString(pPoseStack, this.font, component, this.getX() + this.width - this.font.width(component), this.getY() + this.height + 4, 10526880);
      }
