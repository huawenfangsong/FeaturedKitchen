...
public class WorldOpenFlows {
   ...
   public static void confirmWorldCreation(Minecraft pMinecraft, CreateWorldScreen pLastScreen, Lifecycle pLifecycle, Runnable p_233130_) {
      BooleanConsumer booleanconsumer = (p_233154_) -> {
         if (p_233154_) {
            p_233130_.run();
         } else {
            pMinecraft.setScreen(pLastScreen);
         }
