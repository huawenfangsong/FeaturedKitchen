...
public class Gui extends GuiComponent {
   ...
   public void render(PoseStack pPoseStack, float pPartialTick) {
      ...
      float f1 = Mth.lerp(pPartialTick, this.minecraft.player.oPortalTime, this.minecraft.player.portalTime);
      ...
      if (!this.minecraft.options.hideGui) {
         ...
         if (playerrideablejumping != null) {
            this.renderJumpMeter(playerrideablejumping, pPoseStack, i);
      ...
      if (!this.minecraft.options.hideGui) {
         if (this.overlayMessageString != null && this.overlayMessageTime > 0) {
            ...
            if (j1 > 8) {
               pPoseStack.pushPose();
               pPoseStack.translate((float)(this.screenWidth / 2), (float)(this.screenHeight - 68), 0.0F);
               RenderSystem.enableBlend();
               RenderSystem.defaultBlendFunc();
               int l1 = 16777215;
               ...
               font.drawShadow(pPoseStack, this.overlayMessageString, (float)(-l / 2), -4.0F, l1 | k);
               RenderSystem.disableBlend();
               pPoseStack.popPose();
            }
         ...
         if (this.title != null && this.titleTime > 0) {
            ...
            if (k1 > 8) {
               pPoseStack.pushPose();
               pPoseStack.translate((float)(this.screenWidth / 2), (float)(this.screenHeight / 2), 0.0F);
               RenderSystem.enableBlend();
               RenderSystem.defaultBlendFunc();
               pPoseStack.pushPose();
               ...
               this.drawBackdrop(pPoseStack, font, -10, j2, 16777215 | i2);
               font.drawShadow(pPoseStack, this.title, (float)(-j2 / 2), -10.0F, 16777215 | i2);
               pPoseStack.popPose();
               if (this.subtitle != null) {
                  pPoseStack.pushPose();
                  pPoseStack.scale(2.0F, 2.0F, 2.0F);
                  int l2 = font.width(this.subtitle);
                  this.drawBackdrop(pPoseStack, font, 5, l2, 16777215 | i2);
                  font.drawShadow(pPoseStack, this.subtitle, (float)(-l2 / 2), 5.0F, 16777215 | i2);
                  pPoseStack.popPose();
               }
         ...
         this.chat.render(pPoseStack, this.tickCount, i3, i1);
         this.minecraft.getProfiler().pop();
   ...
   public void renderJumpMeter(PlayerRideableJumping pRideable, PoseStack pPoseStack, int pX) {
      ...
      if (pRideable.getJumpCooldown() > 0) {
         this.blit(pPoseStack, pX, k, 0, 74, 182, 5);
      } else if (j > 0) {
   ...
   private void renderSlot(int pX, int pY, float pPartialTick, Player pPlayer, ItemStack pStack, int p_168683_) {
      if (!pStack.isEmpty()) {
         ...
         if (f > 0.0F) {
            ...
            posestack.pushPose();
            posestack.translate((float)(pX + 8), (float)(pY + 12), 0.0F);
   ...
   private void renderSavingIndicator(PoseStack pPoseStack) {
      if (this.minecraft.options.showAutosaveIndicator().get() && (this.autosaveIndicatorValue > 0.0F || this.lastAutosaveIndicatorValue > 0.0F)) {
         ...
         if (i > 8) {
            ...
            font.drawShadow(pPoseStack, SAVING_TEXT, (float)(this.screenWidth - j - 10), (float)(this.screenHeight - 15), k);
         }
      }
