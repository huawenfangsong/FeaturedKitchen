...
public class Font {
   ...
   public int drawInBatch(String pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      return this.drawInBatch(pText, pX, pY, pColor, pDropShadow, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords, this.isBidirectional());
   }

   public int drawInBatch(String pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords, boolean pBidirectional) {
      return this.drawInternal(pText, pX, pY, pColor, pDropShadow, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords, pBidirectional);
   }

   public int drawInBatch(Component pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      return this.drawInBatch(pText.getVisualOrderText(), pX, pY, pColor, pDropShadow, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords);
   }

   public int drawInBatch(FormattedCharSequence pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      return this.drawInternal(pText, pX, pY, pColor, pDropShadow, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords);
   }
   ...
   private int drawInternal(String pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords, boolean pBidrectional) {
      if (pBidrectional) {
      ...
      if (pDropShadow) {
         this.renderText(pText, pX, pY, pColor, true, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords);
         matrix4f.translate(SHADOW_OFFSET);
      }

      pX = this.renderText(pText, pX, pY, pColor, false, matrix4f, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords);
      return (int)pX + (pDropShadow ? 1 : 0);
   }

   private int drawInternal(FormattedCharSequence pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      pColor = adjustColor(pColor);
      Matrix4f matrix4f = new Matrix4f(pMatrix);
      if (pDropShadow) {
         this.renderText(pText, pX, pY, pColor, true, pMatrix, pBufferSource, pTransparent, pBackgroundColor, pPackedLightCoords);
   ...
   private float renderText(String pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(pBufferSource, pX, pY, pColor, pDropShadow, pMatrix, pTransparent, pPackedLightCoords);
   ...
   private float renderText(FormattedCharSequence pText, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pMatrix, MultiBufferSource pBufferSource, boolean pTransparent, int pBackgroundColor, int pPackedLightCoords) {
      Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(pBufferSource, pX, pY, pColor, pDropShadow, pMatrix, pTransparent, pPackedLightCoords);
   ...
   class StringRenderOutput implements FormattedCharSink {
      ...
      public StringRenderOutput(MultiBufferSource pBufferSource, float pX, float pY, int pColor, boolean pDropShadow, Matrix4f pPose, boolean pTransparent, int pPackedLightCoords) {
         this(pBufferSource, pX, pY, pColor, pDropShadow, pPose, pTransparent ? Font.DisplayMode.SEE_THROUGH : Font.DisplayMode.NORMAL, pPackedLightCoords);
      }
