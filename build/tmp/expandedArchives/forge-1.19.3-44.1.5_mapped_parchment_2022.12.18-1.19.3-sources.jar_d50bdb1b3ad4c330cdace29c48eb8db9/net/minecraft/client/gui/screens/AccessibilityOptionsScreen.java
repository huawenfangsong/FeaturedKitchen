...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
   ...
   private static OptionInstance<?>[] options(Options pOptions) {
      return new OptionInstance[]{pOptions.narrator(), pOptions.showSubtitles(), pOptions.textBackgroundOpacity(), pOptions.backgroundForChatOnly(), pOptions.chatOpacity(), pOptions.chatLineSpacing(), pOptions.chatDelay(), pOptions.autoJump(), pOptions.toggleCrouch(), pOptions.toggleSprint(), pOptions.screenEffectScale(), pOptions.fovEffectScale(), pOptions.darkMojangStudiosBackground(), pOptions.hideLightningFlash(), pOptions.darknessEffectScale(), pOptions.panoramaSpeed()};
   }
