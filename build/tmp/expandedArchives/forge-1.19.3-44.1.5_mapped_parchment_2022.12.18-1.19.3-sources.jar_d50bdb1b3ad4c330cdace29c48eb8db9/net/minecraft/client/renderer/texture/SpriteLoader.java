...
public class SpriteLoader {
   ...
   public SpriteLoader(ResourceLocation pLocation, int pMaxSupportedTextureSize) {
      this.location = pLocation;
      this.maxSupportedTextureSize = pMaxSupportedTextureSize;
   }

   public static SpriteLoader create(TextureAtlas pAtlas) {
      return new SpriteLoader(pAtlas.location(), pAtlas.maxSupportedTextureSize());
   }

   public SpriteLoader.Preparations stitch(List<SpriteContents> pContents, int p_261919_, Executor p_261665_) {
   ...
   public CompletableFuture<SpriteLoader.Preparations> loadAndStitch(ResourceManager pResouceManager, ResourceLocation pLocation, int p_262104_, Executor p_261687_) {
   ...
   private Map<ResourceLocation, TextureAtlasSprite> getStitchedSprites(Stitcher<SpriteContents> pStitcher) {
      Map<ResourceLocation, TextureAtlasSprite> map = new HashMap<>();
      int i = pStitcher.getWidth();
      int j = pStitcher.getHeight();
