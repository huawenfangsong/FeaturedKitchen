...
public class Unstitcher implements SpriteSource {
   ...
   public void run(ResourceManager pResourceManager, SpriteSource.Output pOutput) {
      ...
      if (optional.isPresent()) {
         ...
         for(Unstitcher.Region unstitcher$region : this.regions) {
            pOutput.add(unstitcher$region.sprite, new Unstitcher.RegionInstance(unstitcher$lazyloadedimage, unstitcher$region, this.xDivisor, this.yDivisor));
         }
      } else {
   ...
   static class LazyLoadedImage {
      ...
      LazyLoadedImage(ResourceLocation pId, Resource pResource, int pReferenceCount) {
         this.id = pId;
   ...
   static class RegionInstance implements SpriteSource.SpriteSupplier {
      ...
      RegionInstance(Unstitcher.LazyLoadedImage pImage, Unstitcher.Region pRegion, double pXDivisor, double pYDivisor) {
         this.image = pImage;
         this.region = pRegion;
