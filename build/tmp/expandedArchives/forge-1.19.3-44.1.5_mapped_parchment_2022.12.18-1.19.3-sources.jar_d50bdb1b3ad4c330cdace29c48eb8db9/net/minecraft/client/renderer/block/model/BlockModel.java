...
public class BlockModel implements UnbakedModel {
   ...
   public BakedModel bakeVanilla(ModelBaker pBaker, BlockModel pModel, Function<Material, TextureAtlasSprite> pSpriteGetter, ModelState pState, ResourceLocation pLocation, boolean pGuiLight3d, net.minecraftforge.client.RenderTypeGroup renderTypes) {
      if (true) return net.minecraftforge.client.model.geometry.UnbakedGeometryHelper.bakeVanilla(this, pBaker, pModel, pSpriteGetter, pState, pLocation); // Redirected, in case anyone actually uses this
