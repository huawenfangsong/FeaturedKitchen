...
public class ChatLog {
   ...
   public static Codec<ChatLog> codec(int pSize) {
      return Codec.list(LoggedChatEvent.CODEC).comapFlatMap((p_254191_) -> {
         return p_254191_.size() > pSize ? DataResult.error("Expected: a buffer of size less than or equal to " + pSize + " but: " + p_254191_.size() + " is greater than " + pSize) : DataResult.success(new ChatLog(pSize, p_254191_));
