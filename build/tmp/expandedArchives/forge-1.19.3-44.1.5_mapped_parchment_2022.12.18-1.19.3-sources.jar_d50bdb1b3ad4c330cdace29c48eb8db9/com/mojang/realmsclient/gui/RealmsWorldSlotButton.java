...
public class RealmsWorldSlotButton extends Button {
   ...
   public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
      if (this.state != null) {
         this.drawSlotFrame(pPoseStack, this.getX(), this.getY(), pMouseX, pMouseY, this.state.isCurrentlyActiveSlot, this.state.slotName, this.slotIndex, this.state.imageId, this.state.image, this.state.empty, this.state.minigame, this.state.action, this.state.actionPrompt);
      }
   }
