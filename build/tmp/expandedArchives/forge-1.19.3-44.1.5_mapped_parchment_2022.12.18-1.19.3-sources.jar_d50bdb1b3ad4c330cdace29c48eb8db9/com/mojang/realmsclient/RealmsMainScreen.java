...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
      ...
      if (this.trialsAvailable && !this.createdTrial && this.shouldShowPopup()) {
         ...
         GuiComponent.blit(pPoseStack, this.createTrialButton.getX() + this.createTrialButton.getWidth() - 8 - 4, this.createTrialButton.getY() + this.createTrialButton.getHeight() / 2 - 4, 0.0F, (float)k, 8, 8, 8, 16);
      }
   ...
   private void renderLocal(PoseStack pPoseStack) {
      ...
      RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
      pPoseStack.pushPose();
      pPoseStack.translate((float)(this.width / 2 - 25), 20.0F, 0.0F);
