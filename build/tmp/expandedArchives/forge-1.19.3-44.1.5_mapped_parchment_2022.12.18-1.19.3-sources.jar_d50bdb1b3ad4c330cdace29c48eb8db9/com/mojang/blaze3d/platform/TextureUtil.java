...
public class TextureUtil {
   ...
   public static void writeAsPNG(Path p_261923_, String pTextureName, int pTextureId, int pAmount, int pWidth, int pHeight) {
      ...
      for(int i = 0; i <= pAmount; ++i) {
         ...
         try (NativeImage nativeimage = new NativeImage(j, k, false)) {
            ...
            Path path = p_261923_.resolve(pTextureName + "_" + i + ".png");
