...
public final class Window implements AutoCloseable {
   ...
   public void setIcon(IoSupplier<InputStream> pIconStream16X, IoSupplier<InputStream> pIconStream32X) {
      RenderSystem.assertInInitPhase();
   ...
   @Nullable
   private ByteBuffer readIconPixels(IoSupplier<InputStream> pTextureStream, IntBuffer pX, IntBuffer pY, IntBuffer pChannelInFile) throws IOException {
      RenderSystem.assertInInitPhase();
      ByteBuffer bytebuffer = null;

      ByteBuffer bytebuffer1;
      try (InputStream inputstream = pTextureStream.get()) {
